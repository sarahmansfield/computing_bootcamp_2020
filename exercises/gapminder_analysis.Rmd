...
ggplot(data = gap_canada, mapping = aes(x = gdpPercap, y = lifeExp)) +
...
```{r ex3_part1}
gap_africaeurope1992 <- gap %>% 
  filter(continent %in% c("Africa", "Europe"), year == 1992)

ggplot(data = gap_africaeurope1992, mapping = aes(x = gdpPercap, y = lifeExp, color = continent)) +
  geom_point()
```
